...
```shell-session
telnet 10.10.60.193 21
Trying 10.10.60.193...
Connected to 10.10.60.193.
Escape character is '^]'.
220 (vsFTPd 3.0.3)
USER frank
...
```shell-session
telnet 10.10.60.193 110
Trying 10.10.60.193...
Connected to 10.10.60.193.
Escape character is '^]'.
+OK 10.10.60.193 Mail Server POP3 Wed, 15 Sep 2021 11:05:34 +0300 
USER frank
+OK frank
PASS D2xc9CgD
...
.
QUIT
+OK 10.10.60.193 closing connection
Connection closed by foreign host.
```
